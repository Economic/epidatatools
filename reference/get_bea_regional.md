...
#> Error in purrr::map2(combinations$geo, combinations$line, function(geo,     line) {    fetch_bea_regional(geo_fips = geo, table_name = table_name,         line_code = line, years_param = years_param, bea_api_key = bea_api_key)}): ℹ In index: 1.
