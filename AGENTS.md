...
- `get_bea_regional(geo_fips, tables, years, line_code, metadata, bea_api_key)`: Retrieves regional economic data from the Bureau of Economic Analysis (BEA) API. Requires a BEA API key.
